...
public class TextRecognitionStud extends AppCompatActivity {
    ...
    //    UI views
    private Button input_img1;
    private Button input_scan1;
    private ShapeableImageView img_iv1;
    private EditText recog_txt_et1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_text_recognition_stud);

        ImageView txt_rec_stud_back = (ImageView) findViewById(R.id.txt_rec_std_back);
        txt_rec_stud_back.setOnClickListener(new View.OnClickListener() {
        ...
        //        init UI views
        input_img1 = findViewById(R.id.input_img1);
        input_scan1 = findViewById(R.id.input_scan1);
        img_iv1 = findViewById(R.id.img_iv1);
        recog_txt_et1 = findViewById(R.id.recog_txt_et1);
...
//        handle click, show input image dialog
        input_img1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        input_scan1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//            Exception occurred while preparing InputImage, dismiss dialog, show reason in Toast
    ...
    private void showInputImageDialog() {
        PopupMenu popupMenu = new PopupMenu(this, input_img1);
